...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 19 22:24:48 2022
...
plt.xlabel('Surface Tension', fontsize=15)
...
trial_fit = model.fit(predictors_train, targets_train, epochs=250, verbose=1, validation_split=0.1)
...
density_scatter(targets_test.reshape(-1), predictions.reshape(-1), bins = [50,5])